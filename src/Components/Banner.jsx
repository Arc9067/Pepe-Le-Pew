        ...
        <article className="w-full md:w-[700px] md:h-[400px] bg-[#F30709] h-[500px] rounded-md  flex justify-center flex-col p-10">
          ...
          <div className="font-Modak flex-wrap justify-center items-start gap-4 inline-flex">
            ...
            <div
              ...
              className="h-[66px] hover:scale-95 transition p-[3px] rounded-full border border-blue-400 justify-center items-center flex"
            >
              <div className="grow shrink basis-0 self-stretch px-8 py-4 bg-blue-400  rounded-full justify-center items-center gap-2.5 inline-flex">
                <div className="text-white text-xl font-normal leading-7 tracking-wider">
                  NO!
                </div>
              </div>
